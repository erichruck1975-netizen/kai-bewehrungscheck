const CACHE = "kai-bewehrungscheck-v104";
const ASSETS = ["./", "./index.html", "./styles.css?v=104", "./app.js?v=104", "./manifest.webmanifest?v=104", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=104", "./vendor/pdfjs/pdf.worker.min.js?v=104"];
