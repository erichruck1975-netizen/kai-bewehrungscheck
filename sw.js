const CACHE = "kai-bewehrungscheck-v124";
const ASSETS = ["./", "./index.html", "./styles.css?v=124", "./app.js?v=124", "./manifest.webmanifest?v=124", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=124", "./vendor/pdfjs/pdf.worker.min.js?v=124"];
