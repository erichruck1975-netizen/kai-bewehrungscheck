const CACHE = "kai-bewehrungscheck-v65";
const ASSETS = ["./", "./index.html", "./styles.css?v=65", "./app.js?v=65", "./manifest.webmanifest?v=65", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=65", "./vendor/pdfjs/pdf.worker.min.js?v=65"];
