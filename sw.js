const CACHE = "kai-bewehrungscheck-v180";
const ASSETS = ["./", "./index.html", "./styles.css?v=180", "./app.js?v=180", "./manifest.webmanifest?v=180", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=180", "./vendor/pdfjs/pdf.worker.min.js?v=180"];
