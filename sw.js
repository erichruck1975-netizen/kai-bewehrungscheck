const CACHE = "kai-bewehrungscheck-v60";
const ASSETS = ["./", "./index.html", "./styles.css?v=60", "./app.js?v=60", "./manifest.webmanifest?v=60", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=60", "./vendor/pdfjs/pdf.worker.min.js?v=60"];
