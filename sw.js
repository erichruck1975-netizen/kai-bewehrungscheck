const CACHE = "kai-bewehrungscheck-v80";
const ASSETS = ["./", "./index.html", "./styles.css?v=80", "./app.js?v=80", "./manifest.webmanifest?v=80", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=80", "./vendor/pdfjs/pdf.worker.min.js?v=80"];
