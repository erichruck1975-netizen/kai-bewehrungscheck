const CACHE = "kai-bewehrungscheck-v77";
const ASSETS = ["./", "./index.html", "./styles.css?v=77", "./app.js?v=77", "./manifest.webmanifest?v=77", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=77", "./vendor/pdfjs/pdf.worker.min.js?v=77"];
