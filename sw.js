const CACHE = "kai-bewehrungscheck-v151";
const ASSETS = ["./", "./index.html", "./styles.css?v=151", "./app.js?v=151", "./manifest.webmanifest?v=151", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=151", "./vendor/pdfjs/pdf.worker.min.js?v=151"];
