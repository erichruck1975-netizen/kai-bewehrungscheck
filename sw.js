const CACHE = "kai-bewehrungscheck-v164";
const ASSETS = ["./", "./index.html", "./styles.css?v=164", "./app.js?v=164", "./manifest.webmanifest?v=164", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=164", "./vendor/pdfjs/pdf.worker.min.js?v=164"];
