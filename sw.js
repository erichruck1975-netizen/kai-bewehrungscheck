const CACHE = "kai-bewehrungscheck-v136";
const ASSETS = ["./", "./index.html", "./styles.css?v=136", "./app.js?v=136", "./manifest.webmanifest?v=136", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=136", "./vendor/pdfjs/pdf.worker.min.js?v=136"];
