const CACHE = "kai-bewehrungscheck-v141";
const ASSETS = ["./", "./index.html", "./styles.css?v=141", "./app.js?v=141", "./manifest.webmanifest?v=141", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=141", "./vendor/pdfjs/pdf.worker.min.js?v=141"];
