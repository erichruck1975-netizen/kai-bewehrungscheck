const CACHE = "kai-bewehrungscheck-v186";
const ASSETS = ["./", "./index.html", "./styles.css?v=186", "./app.js?v=186", "./manifest.webmanifest?v=186", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=186", "./vendor/pdfjs/pdf.worker.min.js?v=186"];
