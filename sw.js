const CACHE = "kai-bewehrungscheck-v99";
const ASSETS = ["./", "./index.html", "./styles.css?v=99", "./app.js?v=99", "./manifest.webmanifest?v=99", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=99", "./vendor/pdfjs/pdf.worker.min.js?v=99"];
