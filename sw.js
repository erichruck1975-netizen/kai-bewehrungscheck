const CACHE = "kai-bewehrungscheck-v78";
const ASSETS = ["./", "./index.html", "./styles.css?v=78", "./app.js?v=78", "./manifest.webmanifest?v=78", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=78", "./vendor/pdfjs/pdf.worker.min.js?v=78"];
