const CACHE = "kai-bewehrungscheck-v122";
const ASSETS = ["./", "./index.html", "./styles.css?v=122", "./app.js?v=122", "./manifest.webmanifest?v=122", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=122", "./vendor/pdfjs/pdf.worker.min.js?v=122"];
