const CACHE = "kai-bewehrungscheck-v167";
const ASSETS = ["./", "./index.html", "./styles.css?v=167", "./app.js?v=167", "./manifest.webmanifest?v=167", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=167", "./vendor/pdfjs/pdf.worker.min.js?v=167"];
