const CACHE = "kai-bewehrungscheck-v107";
const ASSETS = ["./", "./index.html", "./styles.css?v=107", "./app.js?v=107", "./manifest.webmanifest?v=107", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=107", "./vendor/pdfjs/pdf.worker.min.js?v=107"];
