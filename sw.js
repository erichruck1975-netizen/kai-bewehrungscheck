const CACHE = "kai-bewehrungscheck-v98";
const ASSETS = ["./", "./index.html", "./styles.css?v=98", "./app.js?v=98", "./manifest.webmanifest?v=98", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=98", "./vendor/pdfjs/pdf.worker.min.js?v=98"];
