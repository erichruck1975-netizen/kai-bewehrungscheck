const CACHE = "kai-bewehrungscheck-v140";
const ASSETS = ["./", "./index.html", "./styles.css?v=140", "./app.js?v=140", "./manifest.webmanifest?v=140", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=140", "./vendor/pdfjs/pdf.worker.min.js?v=140"];
