const CACHE = "kai-bewehrungscheck-v121";
const ASSETS = ["./", "./index.html", "./styles.css?v=121", "./app.js?v=121", "./manifest.webmanifest?v=121", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=121", "./vendor/pdfjs/pdf.worker.min.js?v=121"];
