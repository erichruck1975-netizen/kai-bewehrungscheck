const CACHE = "kai-bewehrungscheck-v67";
const ASSETS = ["./", "./index.html", "./styles.css?v=67", "./app.js?v=67", "./manifest.webmanifest?v=67", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=67", "./vendor/pdfjs/pdf.worker.min.js?v=67"];
