const CACHE = "kai-bewehrungscheck-v94";
const ASSETS = ["./", "./index.html", "./styles.css?v=94", "./app.js?v=94", "./manifest.webmanifest?v=94", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=94", "./vendor/pdfjs/pdf.worker.min.js?v=94"];
