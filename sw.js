const CACHE = "kai-bewehrungscheck-v166";
const ASSETS = ["./", "./index.html", "./styles.css?v=166", "./app.js?v=166", "./manifest.webmanifest?v=166", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=166", "./vendor/pdfjs/pdf.worker.min.js?v=166"];
