const CACHE = "kai-bewehrungscheck-v201";
const ASSETS = ["./", "./index.html", "./styles.css?v=201", "./app.js?v=201", "./manifest.webmanifest?v=200", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=200", "./vendor/pdfjs/pdf.worker.min.js?v=200"];
