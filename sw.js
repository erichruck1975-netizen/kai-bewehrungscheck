const CACHE = "kai-bewehrungscheck-v192";
const ASSETS = ["./", "./index.html", "./styles.css?v=192", "./app.js?v=192", "./manifest.webmanifest?v=192", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=192", "./vendor/pdfjs/pdf.worker.min.js?v=192"];
