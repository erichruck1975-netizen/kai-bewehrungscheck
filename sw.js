const CACHE = "kai-bewehrungscheck-v171";
const ASSETS = ["./", "./index.html", "./styles.css?v=171", "./app.js?v=171", "./manifest.webmanifest?v=171", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=171", "./vendor/pdfjs/pdf.worker.min.js?v=171"];
