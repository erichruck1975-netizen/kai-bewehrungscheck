const CACHE = "kai-bewehrungscheck-v153";
const ASSETS = ["./", "./index.html", "./styles.css?v=153", "./app.js?v=153", "./manifest.webmanifest?v=153", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=153", "./vendor/pdfjs/pdf.worker.min.js?v=153"];
