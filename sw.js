const CACHE = "kai-bewehrungscheck-v155";
const ASSETS = ["./", "./index.html", "./styles.css?v=155", "./app.js?v=155", "./manifest.webmanifest?v=155", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=155", "./vendor/pdfjs/pdf.worker.min.js?v=155"];
