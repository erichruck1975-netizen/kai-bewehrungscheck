const CACHE = "kai-bewehrungscheck-v95";
const ASSETS = ["./", "./index.html", "./styles.css?v=95", "./app.js?v=95", "./manifest.webmanifest?v=95", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=95", "./vendor/pdfjs/pdf.worker.min.js?v=95"];
