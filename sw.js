const CACHE = "kai-bewehrungscheck-v152";
const ASSETS = ["./", "./index.html", "./styles.css?v=152", "./app.js?v=152", "./manifest.webmanifest?v=152", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=152", "./vendor/pdfjs/pdf.worker.min.js?v=152"];
