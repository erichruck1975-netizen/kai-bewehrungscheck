const CACHE = "kai-bewehrungscheck-v100";
const ASSETS = ["./", "./index.html", "./styles.css?v=100", "./app.js?v=100", "./manifest.webmanifest?v=100", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=100", "./vendor/pdfjs/pdf.worker.min.js?v=100"];
