const CACHE = "kai-bewehrungscheck-v199";
const ASSETS = ["./", "./index.html", "./styles.css?v=199", "./app.js?v=199", "./manifest.webmanifest?v=199", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=199", "./vendor/pdfjs/pdf.worker.min.js?v=199"];
