const CACHE = "kai-bewehrungscheck-v119";
const ASSETS = ["./", "./index.html", "./styles.css?v=119", "./app.js?v=119", "./manifest.webmanifest?v=119", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=119", "./vendor/pdfjs/pdf.worker.min.js?v=119"];
