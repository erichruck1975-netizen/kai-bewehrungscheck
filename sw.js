const CACHE = "kai-bewehrungscheck-v72";
const ASSETS = ["./", "./index.html", "./styles.css?v=72", "./app.js?v=72", "./manifest.webmanifest?v=72", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=72", "./vendor/pdfjs/pdf.worker.min.js?v=72"];
