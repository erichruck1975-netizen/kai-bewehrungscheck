const CACHE = "kai-bewehrungscheck-v126";
const ASSETS = ["./", "./index.html", "./styles.css?v=126", "./app.js?v=126", "./manifest.webmanifest?v=126", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=126", "./vendor/pdfjs/pdf.worker.min.js?v=126"];
