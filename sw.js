const CACHE = "kai-bewehrungscheck-v198";
const ASSETS = ["./", "./index.html", "./styles.css?v=198", "./app.js?v=198", "./manifest.webmanifest?v=198", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=198", "./vendor/pdfjs/pdf.worker.min.js?v=198"];
