const CACHE = "kai-bewehrungscheck-v73";
const ASSETS = ["./", "./index.html", "./styles.css?v=73", "./app.js?v=73", "./manifest.webmanifest?v=73", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=73", "./vendor/pdfjs/pdf.worker.min.js?v=73"];
