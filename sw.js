const CACHE = "kai-bewehrungscheck-v106";
const ASSETS = ["./", "./index.html", "./styles.css?v=106", "./app.js?v=106", "./manifest.webmanifest?v=106", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=106", "./vendor/pdfjs/pdf.worker.min.js?v=106"];
