const CACHE = "kai-bewehrungscheck-v149";
const ASSETS = ["./", "./index.html", "./styles.css?v=149", "./app.js?v=149", "./manifest.webmanifest?v=149", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=149", "./vendor/pdfjs/pdf.worker.min.js?v=149"];
