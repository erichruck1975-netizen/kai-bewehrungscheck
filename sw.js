const CACHE = "kai-bewehrungscheck-v86";
const ASSETS = ["./", "./index.html", "./styles.css?v=86", "./app.js?v=86", "./manifest.webmanifest?v=86", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=86", "./vendor/pdfjs/pdf.worker.min.js?v=86"];
