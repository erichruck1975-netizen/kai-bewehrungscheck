const CACHE = "kai-bewehrungscheck-v144";
const ASSETS = ["./", "./index.html", "./styles.css?v=144", "./app.js?v=144", "./manifest.webmanifest?v=144", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=144", "./vendor/pdfjs/pdf.worker.min.js?v=144"];
