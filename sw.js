const CACHE = "kai-bewehrungscheck-v191";
const ASSETS = ["./", "./index.html", "./styles.css?v=191", "./app.js?v=191", "./manifest.webmanifest?v=191", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=191", "./vendor/pdfjs/pdf.worker.min.js?v=191"];
