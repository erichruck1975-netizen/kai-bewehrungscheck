const CACHE = "kai-bewehrungscheck-v133";
const ASSETS = ["./", "./index.html", "./styles.css?v=133", "./app.js?v=133", "./manifest.webmanifest?v=133", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=133", "./vendor/pdfjs/pdf.worker.min.js?v=133"];
