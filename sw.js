const CACHE = "kai-bewehrungscheck-v170";
const ASSETS = ["./", "./index.html", "./styles.css?v=170", "./app.js?v=170", "./manifest.webmanifest?v=170", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=170", "./vendor/pdfjs/pdf.worker.min.js?v=170"];
