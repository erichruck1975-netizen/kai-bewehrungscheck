const CACHE = "kai-bewehrungscheck-v178";
const ASSETS = ["./", "./index.html", "./styles.css?v=178", "./app.js?v=178", "./manifest.webmanifest?v=178", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=178", "./vendor/pdfjs/pdf.worker.min.js?v=178"];
