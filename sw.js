const CACHE = "kai-bewehrungscheck-v108";
const ASSETS = ["./", "./index.html", "./styles.css?v=108", "./app.js?v=108", "./manifest.webmanifest?v=108", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=108", "./vendor/pdfjs/pdf.worker.min.js?v=108"];
