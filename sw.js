const CACHE = "kai-bewehrungscheck-v148";
const ASSETS = ["./", "./index.html", "./styles.css?v=148", "./app.js?v=148", "./manifest.webmanifest?v=148", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=148", "./vendor/pdfjs/pdf.worker.min.js?v=148"];
