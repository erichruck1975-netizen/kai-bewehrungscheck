const CACHE = "kai-bewehrungscheck-v181";
const ASSETS = ["./", "./index.html", "./styles.css?v=181", "./app.js?v=181", "./manifest.webmanifest?v=181", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=181", "./vendor/pdfjs/pdf.worker.min.js?v=181"];
