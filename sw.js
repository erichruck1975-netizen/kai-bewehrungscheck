const CACHE = "kai-bewehrungscheck-v190";
const ASSETS = ["./", "./index.html", "./styles.css?v=190", "./app.js?v=190", "./manifest.webmanifest?v=190", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=190", "./vendor/pdfjs/pdf.worker.min.js?v=190"];
