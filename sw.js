const CACHE = "kai-bewehrungscheck-v187";
const ASSETS = ["./", "./index.html", "./styles.css?v=187", "./app.js?v=187", "./manifest.webmanifest?v=187", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=187", "./vendor/pdfjs/pdf.worker.min.js?v=187"];
