const CACHE = "kai-bewehrungscheck-v165";
const ASSETS = ["./", "./index.html", "./styles.css?v=165", "./app.js?v=165", "./manifest.webmanifest?v=165", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=165", "./vendor/pdfjs/pdf.worker.min.js?v=165"];
