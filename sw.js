const CACHE = "kai-bewehrungscheck-v135";
const ASSETS = ["./", "./index.html", "./styles.css?v=135", "./app.js?v=135", "./manifest.webmanifest?v=135", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=135", "./vendor/pdfjs/pdf.worker.min.js?v=135"];
