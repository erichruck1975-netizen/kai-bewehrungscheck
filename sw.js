const CACHE = "kai-bewehrungscheck-v196";
const ASSETS = ["./", "./index.html", "./styles.css?v=196", "./app.js?v=196", "./manifest.webmanifest?v=196", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=196", "./vendor/pdfjs/pdf.worker.min.js?v=196"];
