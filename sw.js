const CACHE = "kai-bewehrungscheck-v81";
const ASSETS = ["./", "./index.html", "./styles.css?v=81", "./app.js?v=81", "./manifest.webmanifest?v=81", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=81", "./vendor/pdfjs/pdf.worker.min.js?v=81"];
