const CACHE = "kai-bewehrungscheck-v123";
const ASSETS = ["./", "./index.html", "./styles.css?v=123", "./app.js?v=123", "./manifest.webmanifest?v=123", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=123", "./vendor/pdfjs/pdf.worker.min.js?v=123"];
