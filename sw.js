const CACHE = "kai-bewehrungscheck-v92";
const ASSETS = ["./", "./index.html", "./styles.css?v=92", "./app.js?v=92", "./manifest.webmanifest?v=92", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=92", "./vendor/pdfjs/pdf.worker.min.js?v=92"];
