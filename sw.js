const CACHE = "kai-bewehrungscheck-v189";
const ASSETS = ["./", "./index.html", "./styles.css?v=189", "./app.js?v=189", "./manifest.webmanifest?v=189", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=189", "./vendor/pdfjs/pdf.worker.min.js?v=189"];
