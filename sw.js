const CACHE = "kai-bewehrungscheck-v168";
const ASSETS = ["./", "./index.html", "./styles.css?v=168", "./app.js?v=168", "./manifest.webmanifest?v=168", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=168", "./vendor/pdfjs/pdf.worker.min.js?v=168"];
