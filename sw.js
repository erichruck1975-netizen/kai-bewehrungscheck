const CACHE = "kai-bewehrungscheck-v174";
const ASSETS = ["./", "./index.html", "./styles.css?v=174", "./app.js?v=174", "./manifest.webmanifest?v=174", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=174", "./vendor/pdfjs/pdf.worker.min.js?v=174"];
