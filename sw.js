const CACHE = "kai-bewehrungscheck-v87";
const ASSETS = ["./", "./index.html", "./styles.css?v=87", "./app.js?v=87", "./manifest.webmanifest?v=87", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=87", "./vendor/pdfjs/pdf.worker.min.js?v=87"];
