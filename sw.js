const CACHE = "kai-bewehrungscheck-v163";
const ASSETS = ["./", "./index.html", "./styles.css?v=163", "./app.js?v=163", "./manifest.webmanifest?v=163", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=163", "./vendor/pdfjs/pdf.worker.min.js?v=163"];
