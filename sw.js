const CACHE = "kai-bewehrungscheck-v102";
const ASSETS = ["./", "./index.html", "./styles.css?v=102", "./app.js?v=102", "./manifest.webmanifest?v=102", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=102", "./vendor/pdfjs/pdf.worker.min.js?v=102"];
