const CACHE = "kai-bewehrungscheck-v172";
const ASSETS = ["./", "./index.html", "./styles.css?v=172", "./app.js?v=172", "./manifest.webmanifest?v=172", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=172", "./vendor/pdfjs/pdf.worker.min.js?v=172"];
