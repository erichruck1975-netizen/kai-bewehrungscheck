const CACHE = "kai-bewehrungscheck-v84";
const ASSETS = ["./", "./index.html", "./styles.css?v=84", "./app.js?v=84", "./manifest.webmanifest?v=84", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=84", "./vendor/pdfjs/pdf.worker.min.js?v=84"];
