const CACHE = "kai-bewehrungscheck-v177";
const ASSETS = ["./", "./index.html", "./styles.css?v=177", "./app.js?v=177", "./manifest.webmanifest?v=177", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=177", "./vendor/pdfjs/pdf.worker.min.js?v=177"];
