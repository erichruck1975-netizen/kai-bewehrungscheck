const CACHE = "kai-bewehrungscheck-v71";
const ASSETS = ["./", "./index.html", "./styles.css?v=71", "./app.js?v=71", "./manifest.webmanifest?v=71", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=71", "./vendor/pdfjs/pdf.worker.min.js?v=71"];
