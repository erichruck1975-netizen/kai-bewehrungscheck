const CACHE = "kai-bewehrungscheck-v139";
const ASSETS = ["./", "./index.html", "./styles.css?v=139", "./app.js?v=139", "./manifest.webmanifest?v=139", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=139", "./vendor/pdfjs/pdf.worker.min.js?v=139"];
