const CACHE = "kai-bewehrungscheck-v200";
const ASSETS = ["./", "./index.html", "./styles.css?v=200", "./app.js?v=200", "./manifest.webmanifest?v=200", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=200", "./vendor/pdfjs/pdf.worker.min.js?v=200"];
