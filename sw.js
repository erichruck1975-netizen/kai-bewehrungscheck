const CACHE = "kai-bewehrungscheck-v85";
const ASSETS = ["./", "./index.html", "./styles.css?v=85", "./app.js?v=85", "./manifest.webmanifest?v=85", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=85", "./vendor/pdfjs/pdf.worker.min.js?v=85"];
