const CACHE = "kai-bewehrungscheck-v146";
const ASSETS = ["./", "./index.html", "./styles.css?v=146", "./app.js?v=146", "./manifest.webmanifest?v=146", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=146", "./vendor/pdfjs/pdf.worker.min.js?v=146"];
