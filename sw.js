const CACHE = "kai-bewehrungscheck-v184";
const ASSETS = ["./", "./index.html", "./styles.css?v=184", "./app.js?v=184", "./manifest.webmanifest?v=184", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=184", "./vendor/pdfjs/pdf.worker.min.js?v=184"];
