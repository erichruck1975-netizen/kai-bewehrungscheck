const CACHE = "kai-bewehrungscheck-v147";
const ASSETS = ["./", "./index.html", "./styles.css?v=147", "./app.js?v=147", "./manifest.webmanifest?v=147", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=147", "./vendor/pdfjs/pdf.worker.min.js?v=147"];
