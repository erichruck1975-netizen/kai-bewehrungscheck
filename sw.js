const CACHE = "kai-bewehrungscheck-v91";
const ASSETS = ["./", "./index.html", "./styles.css?v=91", "./app.js?v=91", "./manifest.webmanifest?v=91", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=91", "./vendor/pdfjs/pdf.worker.min.js?v=91"];
