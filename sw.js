const CACHE = "kai-bewehrungscheck-v93";
const ASSETS = ["./", "./index.html", "./styles.css?v=93", "./app.js?v=93", "./manifest.webmanifest?v=93", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=93", "./vendor/pdfjs/pdf.worker.min.js?v=93"];
