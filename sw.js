const CACHE = "kai-bewehrungscheck-v154";
const ASSETS = ["./", "./index.html", "./styles.css?v=154", "./app.js?v=154", "./manifest.webmanifest?v=154", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=154", "./vendor/pdfjs/pdf.worker.min.js?v=154"];
