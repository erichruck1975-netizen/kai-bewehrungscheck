const CACHE = "kai-bewehrungscheck-v125";
const ASSETS = ["./", "./index.html", "./styles.css?v=125", "./app.js?v=125", "./manifest.webmanifest?v=125", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=125", "./vendor/pdfjs/pdf.worker.min.js?v=125"];
