const CACHE = "kai-bewehrungscheck-v145";
const ASSETS = ["./", "./index.html", "./styles.css?v=145", "./app.js?v=145", "./manifest.webmanifest?v=145", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=145", "./vendor/pdfjs/pdf.worker.min.js?v=145"];
