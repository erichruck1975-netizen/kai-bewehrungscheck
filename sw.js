const CACHE = "kai-bewehrungscheck-v83";
const ASSETS = ["./", "./index.html", "./styles.css?v=83", "./app.js?v=83", "./manifest.webmanifest?v=83", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=83", "./vendor/pdfjs/pdf.worker.min.js?v=83"];
