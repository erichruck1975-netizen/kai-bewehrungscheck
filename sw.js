const CACHE = "kai-bewehrungscheck-v175";
const ASSETS = ["./", "./index.html", "./styles.css?v=175", "./app.js?v=175", "./manifest.webmanifest?v=175", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=175", "./vendor/pdfjs/pdf.worker.min.js?v=175"];
