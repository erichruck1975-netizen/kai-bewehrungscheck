const CACHE = "kai-bewehrungscheck-v137";
const ASSETS = ["./", "./index.html", "./styles.css?v=137", "./app.js?v=137", "./manifest.webmanifest?v=137", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=137", "./vendor/pdfjs/pdf.worker.min.js?v=137"];
