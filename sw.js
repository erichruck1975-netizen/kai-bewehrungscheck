const CACHE = "kai-bewehrungscheck-v103";
const ASSETS = ["./", "./index.html", "./styles.css?v=103", "./app.js?v=103", "./manifest.webmanifest?v=103", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=103", "./vendor/pdfjs/pdf.worker.min.js?v=103"];
