const CACHE = "kai-bewehrungscheck-v197";
const ASSETS = ["./", "./index.html", "./styles.css?v=197", "./app.js?v=197", "./manifest.webmanifest?v=197", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=197", "./vendor/pdfjs/pdf.worker.min.js?v=197"];
