const CACHE = "kai-bewehrungscheck-v61";
const ASSETS = ["./", "./index.html", "./styles.css?v=61", "./app.js?v=61", "./manifest.webmanifest?v=61", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=61", "./vendor/pdfjs/pdf.worker.min.js?v=61"];
