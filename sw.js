const CACHE = "kai-bewehrungscheck-v69";
const ASSETS = ["./", "./index.html", "./styles.css?v=69", "./app.js?v=69", "./manifest.webmanifest?v=69", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=69", "./vendor/pdfjs/pdf.worker.min.js?v=69"];
