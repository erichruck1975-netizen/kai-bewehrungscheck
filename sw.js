const CACHE = "kai-bewehrungscheck-v97";
const ASSETS = ["./", "./index.html", "./styles.css?v=97", "./app.js?v=97", "./manifest.webmanifest?v=97", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=97", "./vendor/pdfjs/pdf.worker.min.js?v=97"];
