const CACHE = "kai-bewehrungscheck-v183";
const ASSETS = ["./", "./index.html", "./styles.css?v=183", "./app.js?v=183", "./manifest.webmanifest?v=183", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=183", "./vendor/pdfjs/pdf.worker.min.js?v=183"];
