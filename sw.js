const CACHE = "kai-bewehrungscheck-v134";
const ASSETS = ["./", "./index.html", "./styles.css?v=134", "./app.js?v=134", "./manifest.webmanifest?v=134", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=134", "./vendor/pdfjs/pdf.worker.min.js?v=134"];
