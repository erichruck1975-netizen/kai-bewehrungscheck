const CACHE = "kai-bewehrungscheck-v195";
const ASSETS = ["./", "./index.html", "./styles.css?v=195", "./app.js?v=195", "./manifest.webmanifest?v=195", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=195", "./vendor/pdfjs/pdf.worker.min.js?v=195"];
