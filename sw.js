const CACHE = "kai-bewehrungscheck-v169";
const ASSETS = ["./", "./index.html", "./styles.css?v=169", "./app.js?v=169", "./manifest.webmanifest?v=169", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=169", "./vendor/pdfjs/pdf.worker.min.js?v=169"];
