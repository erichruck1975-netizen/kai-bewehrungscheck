const CACHE = "kai-bewehrungscheck-v96";
const ASSETS = ["./", "./index.html", "./styles.css?v=96", "./app.js?v=96", "./manifest.webmanifest?v=96", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=96", "./vendor/pdfjs/pdf.worker.min.js?v=96"];
