const CACHE = "kai-bewehrungscheck-v101";
const ASSETS = ["./", "./index.html", "./styles.css?v=101", "./app.js?v=101", "./manifest.webmanifest?v=101", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=101", "./vendor/pdfjs/pdf.worker.min.js?v=101"];
