const CACHE = "kai-bewehrungscheck-v70";
const ASSETS = ["./", "./index.html", "./styles.css?v=70", "./app.js?v=70", "./manifest.webmanifest?v=70", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=70", "./vendor/pdfjs/pdf.worker.min.js?v=70"];
