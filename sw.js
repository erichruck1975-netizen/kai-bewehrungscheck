const CACHE = "kai-bewehrungscheck-v76";
const ASSETS = ["./", "./index.html", "./styles.css?v=76", "./app.js?v=76", "./manifest.webmanifest?v=76", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=76", "./vendor/pdfjs/pdf.worker.min.js?v=76"];
