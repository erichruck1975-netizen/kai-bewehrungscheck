const CACHE = "kai-bewehrungscheck-v59";
const ASSETS = ["./", "./index.html", "./styles.css?v=59", "./app.js?v=59", "./manifest.webmanifest?v=59", "./icon.svg", "./vendor/pdfjs/pdf.min.js?v=59", "./vendor/pdfjs/pdf.worker.min.js?v=59"];
